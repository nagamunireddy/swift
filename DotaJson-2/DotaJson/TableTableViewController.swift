...
protocol loadingDelegate {
    func loadingView(name:String, attack:String, attribute:String, legs:String)
}
    ...
    override func viewDidLoad() {
     ...
     func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
       ...
       cell.textLabel?.text = heroes[indexPath.row].localized_name.capitalized
        cell.attack = "varaprasad"
        cell.attribute = "nothing"
        cell.legs = "2"
        cell.name = "Vinay"
       
        //cell.buttonName.setTitle("pressme", for: .normal)
        //cell.buttonName.setTitle("action", for: .normal)
        return cell
...
//            destination.hero = heroes[(exmpTableView.indexPathForSelectedRow?.row)!]
//        }
//    }
